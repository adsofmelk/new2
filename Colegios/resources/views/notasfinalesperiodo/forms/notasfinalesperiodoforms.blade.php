            ...
            <?php
                ...
                $i=0;    
                    foreach ($notasalumnos as $row){
                        ...
                        $return.="<tr>";
                        $return.="<td><input type='hidden' name='datos[".$i."][0]' value='".$row->codigolista."' />".$row->codigolista."</td>";
                        $return.="<td>".$row->nombres."</td>";
                        $return.="<td>".$row->apellidos."</td>";
                        $return.="<td><input class='nota' type='text' ".$readonly." name='datos[".$i."][1]' value='".$row->notas."' size='3' style='text-align:center'/></td>";
...
{!!Form::hidden("idmateria",$materia_idmateria)!!}
{!!Form::hidden("idcurso",$curso_idcurso)!!}